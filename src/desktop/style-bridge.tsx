...
.kd-desk-mark small { min-width: 0; max-width: 100%; display: grid; justify-items: center; text-align: center; }
...
.kd-desktop-item { position: absolute; width: calc(var(--s7-font-size) * 7); min-height: calc(var(--s7-font-size) * 5.2); pointer-events: auto; display: grid; justify-items: center; align-content: start; gap: 2px; padding: 2px; border: 1px solid transparent; color: var(--s7-ink); background: transparent; font: var(--s7-small-font)/var(--s7-small-line) var(--s7-small-face); text-align: center; }
...
.kd-desktop-item small { font: var(--s7-small-font)/1 var(--s7-small-mono); }
...
.kd-trash-icon .s7-app-icon { width: calc(var(--s7-icon) * 1.25); height: calc(var(--s7-icon) * 1.1); font-size: var(--s7-small-font); }
