...
export function migrateDisplayPreferences(value: unknown): DisplayPreferences {
  ...
  const knownVersion = input.version === 3 || input.version === 4 || input.version === 5 || input.version === 6 || input.version === 7 || input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13
  const resolution = input.resolution === 'dense' ? 'adaptive' : knownVersion ? storedResolution : DEFAULT_DISPLAY_PREFERENCES.resolution
  const baseFontSize = (input.version === 4 || input.version === 5 || input.version === 6 || input.version === 7 || input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.baseFontSize === 10 || input.baseFontSize === 12)
    ? input.baseFontSize as BaseFontSize
    : DEFAULT_DISPLAY_PREFERENCES.baseFontSize
  const pixelScale = (input.version === 4 || input.version === 5 || input.version === 6 || input.version === 7 || input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.pixelScale === 1 || input.pixelScale === 2)
    ? input.pixelScale
  ...
  const wallpaper: DisplayPreferences['wallpaper'] = input.version === 13 && input.wallpaper === 'cat'
    ? 'cat'
    ...
    : (input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11) && (input.wallpaper === 'cats' || input.wallpaper === 'cat2')
      ? 'cat'
      : (input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.wallpaper === 'classic' || input.wallpaper === 'gray' || input.wallpaper === 'pinstripe' || input.wallpaper === 'custom')
        ? input.wallpaper
  ...
  return {
    ...
    filterMode: (input.version === 7 || input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.filterMode === 'monochrome' || input.filterMode === 'grayscale')
      ? input.filterMode
      : DEFAULT_DISPLAY_PREFERENCES.filterMode,
    wallpaper,
    wallpaperFilterMode: (input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.wallpaperFilterMode === 'monochrome' || input.wallpaperFilterMode === 'grayscale')
      ? input.wallpaperFilterMode
      : DEFAULT_DISPLAY_PREFERENCES.wallpaperFilterMode,
    wallpaperPixelSize: (input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.wallpaperPixelSize === 1 || input.wallpaperPixelSize === 2)
      ? input.wallpaperPixelSize
      : DEFAULT_DISPLAY_PREFERENCES.wallpaperPixelSize,
    wallpaperFit: (input.version === 8 || input.version === 9 || input.version === 10 || input.version === 11 || input.version === 12 || input.version === 13) && (input.wallpaperFit === 'tile' || input.wallpaperFit === 'cover')
      ? input.wallpaperFit
